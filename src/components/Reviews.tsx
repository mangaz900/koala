...
const reviews = [
  {
    name: 'Camilla S.',
    stars: 5,
    title: 'Äntligen sover jag ordentligt',
  ...
  },
  {
    name: 'Marcus L.',
    stars: 5,
    title: 'Bästa sömnprodukten jag provat',
  ...
  },
  {
    name: 'Therese K.',
    stars: 5,
    title: 'Mina kvällar känns lugnare nu',
  ...
  },
  {
    name: 'Johan B.',
    stars: 4,
    title: 'Väldigt bra, nöjd kund',
    text: 'Tre veckors användning och jag märker tydlig skillnad i sömnkvaliteten. Vaknar mer utvilad och orkar på ett annat sätt under dagen. Kommer definitivt fortsätta.',
    date: 'Verifierat köp · Feb 2025',
  },
  {
    name: 'Sofia A.',
    stars: 5,
    title: 'Mitt nya kvällsritual',
    text: 'Dessa gummies har blivit en del av min kvällsrutin. Känslan är inte knäpp eller dåsig — bara lugn och naturlig. Prenumererar nu och vill aldrig vara utan!',
    date: 'Verifierat köp · Jan 2025',
  },
  {
    name: 'Erik M.',
    ...
    text: 'Har testat diverse sömnmedel utan framgång. Dessa gummies är milda men effektiva. Premiumkänsla hela vägen, från förpackning till resultat.',
    date: 'Verifierat köp · Mars 2025',
  },
];
